            ...
            while ((line = br.readLine()) != null) {
              ...
              if ("LAUNCH".equals(command)) {
                if (blankIdx == -1) {
                  ...
                  LoboBrowser.getInstance().launch(path);
                }
                ...
                if (blankIdx != -1) {
                  ...
                  if (LoboBrowser.getInstance().verifyAuth(ss.getLocalPort(), key)) {
                    final NavigatorFrame frame = LoboBrowser.getInstance().launch("cobra:blank");
