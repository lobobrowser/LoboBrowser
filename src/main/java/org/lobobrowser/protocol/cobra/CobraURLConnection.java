...
public class CobraURLConnection extends URLConnection {
  ...
  private static String getWelcomeMessage() {
    ...
    return
        ...
        +
        "<p>We recommend that you use this version for casual browsing only and follow the project's <a href='https://blog.lobobrowser.org'>blog</a> to stay abreast of changes.</p>"
        +
        "<p>Other ways of reaching us:</p>" +
        "<ul>" +
          "<li style='margin:1em 0'><a href='https://github.com/LoboBrowser/LoboBrowser'>Source code and issues</a> on GitHub</li>" +
          "<li style='margin:1em 0'>#lobobrowser and #lobobrowser-dev on Freenode IRC</li>" +
          "<li style='margin:1em 0'><a href='https://reddit.com/r/lobobrowser'>/r/lobobrowser</a> on Reddit</li>" +
          "<li style='margin:1em 0'><a href='https://twitter.com/LoboBrowser'>@LoboBrowser</a> on Twitter</li>" +
        "</ul>" +
        "</div>"
        +
