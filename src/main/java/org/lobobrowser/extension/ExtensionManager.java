...
public class ExtensionManager {
  ...
  public static File[] getExtDirs() {
    ...
    if (extDirsProperty == null) {
      final Optional<File> appDirOpt = LoboBrowser.getInstance().getApplicationDirectory();
  ...
  public void addExtension(final Extension ei) {
  ...
  private void loadExtensions(final Collection<Extension> extensions,
    ...
    final LoboBrowser pm = LoboBrowser.getInstance();
  ...
  /**
   * Gets the class loader for a class in an extension
